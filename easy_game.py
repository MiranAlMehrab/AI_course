...
frame.bind("<Button-1>", left_button_click) #Binding the left button click
frame.pack() 
...
def get_computer_move():
    ...
    print("c move called")
    empty_cell_list = get_emplty_index()
